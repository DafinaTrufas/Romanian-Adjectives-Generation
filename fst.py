...
from fst_classes.fst_adj_3_1 import Adj3_1_esc, Adj3_1_velar_consonant, Adj3_1_iu, Adj3_1_u_vowel, Adj3_1_others
from fst_classes.fst_adj_3_2 import Adj3_2_tor, Adj3_2_eu_neologisms, Adj3_2_âu, Adj3_2_ău
...
class Adjective():
    ...
    def get_inflectional_class(self) -> tuple:
        ...
        raise ValueError(f"Adjective stem {self.stem} does not match any inflectional class")
